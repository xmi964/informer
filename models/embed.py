...
class PositionalEmbedding(nn.Module):
    ...
    def forward(self, x):
        return self.pe[:, :x.size(1)].clone()  # 添加clone确保内存安全
...
class TemporalEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        return (hour_x + weekday_x + day_x + month_x + minute_x).clone()
...
class TimeFeatureEmbedding(nn.Module):
    ...
    def forward(self, x):
        return self.embed(x.clone())  # 确保内存安全
